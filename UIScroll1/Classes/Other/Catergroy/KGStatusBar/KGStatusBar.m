...
+ (void)showWithStatus:(NSString*)status {
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:220/255.0 green:87/255.0 blue:87/255.0 alpha:1]  textColor:[UIColor colorWithRed:68.0/255.0 green:68/255.0 blue:68/255.0 alpha:1.0]];
...
- (void)showWithStatus:(NSString *)status barColor:(UIColor*)barColor textColor:(UIColor*)textColor{
    ...
    if(labelText) {
        ...
        labelRect = CGRectMake((self.topBar.frame.size.width / 2) - (stringWidth / 2), 2, stringWidth, stringHeight);
    }
    self.stringLabel.font= [UIFont fontWithName:@"Helvetica" size:15.f];
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
		...
		stringLabel.textColor = [UIColor colorWithRed:68.0/255.0 green:68.0/255.0 blue:68.0/255.0 alpha:1.0];
