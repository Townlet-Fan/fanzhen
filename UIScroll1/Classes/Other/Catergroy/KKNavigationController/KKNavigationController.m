...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (!isExistShadowImage&&self.screenShotsList.count==2) {
       //   NSLog(@"push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!push!!!!!!!!!!!!!!!!!!!");
        isExistShadowImage=YES;
        shadowImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"阴影"]];
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated
{
   ...
   if (isExistShadowImage&&self.screenShotsList.count==1){
        isExistShadowImage=NO;
