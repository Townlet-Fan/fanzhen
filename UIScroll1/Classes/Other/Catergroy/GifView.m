...
-(void)loadData:(NSData *)_data{
    ...
    //获取图像的属性信息
    NSDictionary* frame1Properties = ( NSDictionary*)CFBridgingRelease(CGImageSourceCopyPropertiesAtIndex(gif, 0, NULL));
    ...
    timer = [NSTimer scheduledTimerWithTimeInterval:duration/3.0 target:self selector:@selector(play) userInfo:nil repeats:YES];
    [timer fire];
}
