...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.likeList && indexPath.row < self.itemCount-1) {
        ...
        NSString *iconString = [like.creator iconUrlStrWithType:UMComIconSmallType];
        UIImage *placeHolderImage = [UMComImageView placeHolderImageGender:[like.creator.gender integerValue]];
        [cell.portrait setImageURL:iconString placeHolderImage:placeHolderImage];
    }else{
