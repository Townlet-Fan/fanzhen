...
@property (nonatomic, strong) UMComLoadStatusView *headView;//头

@property (nonatomic, strong) UMComLoadStatusView *footView;//尾
...
@property (nonatomic,assign) LoadStatus  loadStatus;//加载状态（还未，准备，进行，完成）
