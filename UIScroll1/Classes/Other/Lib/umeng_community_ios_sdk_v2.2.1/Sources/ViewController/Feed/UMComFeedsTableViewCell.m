...
//    [self.portrait addGestureRecognizer:tapPortrait];
    ...
    [self.forwardBgView setHidden:YES];
    [self.forwardBgView addGestureRecognizer:tapForward];
    
    [self.likeBgView setFrame:CGRectMake(self.forwardBgView.left,self.forwardBgView.top, self.likeBgView.width, self.likeBgView.height)];
    [self.likeCountLabel setFrame:CGRectMake(self.forwardCountLabel.left,self.forwardCountLabel.top, self.likeCountLabel.width, self.likeCountLabel.height)];
    NSLog(@"self.likeCountLabel:%@,----------%@",self.likeBgView,self.likeCountLabel);
...
{
    NSLog(@"feeddsjlsjfjds:%@",feed.creator);
