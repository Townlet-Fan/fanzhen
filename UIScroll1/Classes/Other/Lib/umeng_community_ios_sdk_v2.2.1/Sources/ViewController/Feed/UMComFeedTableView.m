...
- (void)setTableHeaderView:(UIView *)tableHeaderView
{
    ...
    self.refreshController.headView.frame = CGRectMake(self.refreshController.headView.frame.origin.x,  - self.refreshController.headView.frame.size.height, self.frame.size.width, self.refreshController.headView.frame.size.height);
