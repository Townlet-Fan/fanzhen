...
- (instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
        [self registerClass:[UMComFilterTopicsViewCell class] forCellReuseIdentifier:@"FilterTopicsViewCell"];
...
{
    NSInteger rowHeight = 320;
    
    //UMComFilterTopicsViewCell *cell = (UMComFilterTopicsViewCell*)[self tableView:self cellForRowAtIndexPath:indexPath];
    //rowHeight = cell.height+10;
