...
@property (nonatomic, retain) NSNumber * fans_count;//粉丝数量
@property (nonatomic, retain) NSNumber * feed_count;//帖子数量
@property (nonatomic, retain) NSNumber * following_count;
@property (nonatomic, retain) NSNumber * gender;//性别
@property (nonatomic, retain) NSNumber * has_followed;
@property (nonatomic, retain) id icon_url;//头像URL
