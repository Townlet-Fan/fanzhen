...
//判断是否是首页的画图
@property (nonatomic, assign) BOOL isHomeScroller;

//自定义的标题的text
@property (nonatomic,strong) NSArray *defineNewTitleArray;

//自定义typeButton的text
@property(nonatomic,strong) NSArray *defineNewTypeButtonArray;
