...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!self.isHomeScroller) {
        //临时存放滑图标题的label
        UILabel * scrollerViewTemporaryLabel=[[UILabel alloc]init];
        
        scrollerViewTemporaryLabel.text=_defineNewTitleArray[itemIndex];
        scrollerViewTemporaryLabel.numberOfLines=0;
        // userRespondLable.backgroundColor=[UIColor redColor];
        CGSize userRespondSize=[scrollerViewTemporaryLabel sizeThatFits:CGSizeMake(kWindowSize.width-0.3*kWindowSize.width, 60) ];
        //设置scrollerViewLabel大小
        if (userRespondSize.height>25) {
            
            [cell.scrollerViewLabel setFrame:CGRectMake(0.06*kWindowSize.width,kWindowSize.width*9/16.0-85, kWindowSize.width-0.12*kWindowSize.width, 50) ];
            
            
        }
        else
        {
            [cell.scrollerViewLabel setFrame:CGRectMake(0.06*kWindowSize.width,kWindowSize.width*9/16.0-65, kWindowSize.width-0.12*kWindowSize.width, 30)];
            
            
        }
        //设置蒙版
         cell.scrollerViewDimImageView.image=[UIImage imageNamed:@"16比9阴影"];
        //设置scrollerViewTypeButton大小
        cell.scrollerViewTypeButton.frame=CGRectMake(cell.scrollerViewLabel.left, cell.scrollerViewLabel.bottom+kSpace,KTypeButtonWidth,kTypeButtonHeight);
        [cell.scrollerViewTypeButton setTitleColor:KColor_15_86_192 forState:UIControlStateNormal];
        cell.scrollerViewTypeButton.titleLabel.font=[UIFont systemFontOfSize:12];
        cell.scrollerViewTypeButton.titleLabel.textAlignment=NSTextAlignmentCenter;
        cell.scrollerViewTypeButton.layer.borderColor=[UIColor whiteColor].CGColor;
        cell.scrollerViewTypeButton.layer.borderWidth=1;
        cell.scrollerViewTypeButton.layer.cornerRadius=5;
        [cell.scrollerViewTypeButton setBackgroundColor:[UIColor whiteColor]];
        [cell.scrollerViewTypeButton setTitle:_defineNewTypeButtonArray[itemIndex] forState:UIControlStateNormal];
        
        //设置scrollerViewLabel
        cell.scrollerViewLabel.textColor=[UIColor whiteColor];
        cell.scrollerViewLabel.font=KFont_20;
        cell.scrollerViewLabel.numberOfLines=2;
        cell.scrollerViewLabel.text=_defineNewTitleArray[itemIndex];
