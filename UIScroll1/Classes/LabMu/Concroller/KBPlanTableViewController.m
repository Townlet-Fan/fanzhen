...
@interface KBPlanTableViewController ()<SDCycleScrollViewDelegate>
{
...
@implementation KBPlanTableViewController
...
{
    KBPlanViewCell * planCell;
    static NSString * planIdentifier=@"planIdentifier";
    planCell=[tableView dequeueReusableCellWithIdentifier:planIdentifier];
    if (planCell==nil) {
        planCell=[[KBPlanViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:planIdentifier];
    }
    [planCell setSelected:NO];
    ...
    [planCell setPlanCellWithModel:twoSortIdData.subArticleArray[indexPath.row] ];
    return planCell;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGRect rect = [columnModel.pageTitle boundingRectWithSize:CGSizeMake(kWindowSize.width-20,80) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16]} context:nil];
    return (kWindowSize.width-2*7) * 9/16.0+10+rect.size.height+10+20+15;
}
...
{
    return sectionHeadHeight+7;
    
}
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    KBJudgeTwoSortIdModel * twoSortIdData= columnTypeArray[section];
    KBPlanSectionHeadView * returnView=[[KBPlanSectionHeadView alloc]initWithFrame:CGRectMake(0, 0, kWindowSize.width,sectionHeadHeight) addSectionLabel:twoSortIdData];
...
{
    KBPlanSectionFooterView * sectionFooterView = [[KBPlanSectionFooterView alloc] initWithFrame:CGRectMake(0, 0, kWindowSize.width,10)];
